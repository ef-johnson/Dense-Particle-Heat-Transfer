...
1) Draw the geometry of the walls containing the particles using a CAD program, as a set of surfaces (with no thickness).

2) Mesh the surfaces with triangular elements (using a program such as Gmsh) and save the mesh in STL format in the "mesh" folder.
